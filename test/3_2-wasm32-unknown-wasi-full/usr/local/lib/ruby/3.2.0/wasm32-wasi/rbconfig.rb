...
module RbConfig
  ...
  CONFIG["configure_args"] = " '--host' 'wasm32-wasi' '--build' 'x86_64-pc-linux-gnu' '--with-static-linked-ext' '--with-ext=bigdecimal,cgi/escape,continuation,coverage,date,dbm,digest/bubblebabble,digest,digest/md5,digest/rmd160,digest/sha1,digest/sha2,etc,fcntl,fiber,gdbm,json,json/generator,json/parser,nkf,objspace,pathname,psych,racc/cparse,rbconfig/sizeof,ripper,stringio,strscan,monitor,zlib,openssl' '--with-libyaml-dir=/home/me/build/build/wasm32-unknown-wasi/yaml-0.2.5/opt/usr/local' '--with-zlib-dir=/home/me/build/build/wasm32-unknown-wasi/zlib-1.2.13/opt/usr/local' '--with-openssl-dir=/home/me/build/build/wasm32-unknown-wasi/openssl-3.0.5/opt/usr/local' '--with-baseruby=/home/me/build/build/x86_64-pc-linux-gnu/baseruby-3_2/opt/bin/ruby' 'WASMOPT=/home/me/build/build/toolchain/binaryen/bin/wasm-opt' 'CC=/opt/wasi-sdk/bin/clang' 'LD=/opt/wasi-sdk/bin/clang' 'AR=/opt/wasi-sdk/bin/llvm-ar' 'RANLIB=/opt/wasi-sdk/bin/llvm-ranlib' 'LDFLAGS=-Xlinker -zstack-size=16777216' 'XLDFLAGS=/home/me/build/build/wasm32-unknown-wasi/wasi-vfs-0.1.1/libwasi_vfs.a /home/me/build/build/wasm32-unknown-wasi/3_2-wasm32-unknown-wasi-full-ext/extinit.o' 'XCFLAGS=-DWASM_SETJMP_STACK_BUFFER_SIZE=24576 -DWASM_FIBER_STACK_BUFFER_SIZE=24576 -DWASM_SCAN_STACK_BUFFER_SIZE=24576' 'debugflags=-g0' 'cppflags=' '--disable-install-doc' 'build_alias=x86_64-pc-linux-gnu' 'host_alias=wasm32-wasi'"
